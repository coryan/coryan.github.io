...
distributions.
For example, if we modeled the data as following the
[gamma distribution](https://en.wikipedia.org/wiki/Gamma_distribution)
distribution family -- represented by the dashed line, the samples
would have less kurtosis than the gamma distribution for the same level of
skewness.
Not a good fit then.

The graph tells me that none of the most commonly used distributions
seems to fit this data really well, except maybe the
[Beta distribution](https://en.wikipedia.org/wiki/Beta_distribution).
That would be very strange since Beta arises in a completely different
context.
...
I do not think Gamma appears to be a good fit.
